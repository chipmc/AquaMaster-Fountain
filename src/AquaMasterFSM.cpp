...
#include "Particle.h"
#line 1 "/Users/chipmc/Documents/Maker/Particle/Projects/AquaMaster-Fountain/src/AquaMasterFSM.ino"
/*
...
int setPumpState (String command);
...
int setPumpOnHour (String command);
int setLedOnHour (String command);
int setWeekendOffHour (String command);
int setWeekdayOffHour (String command);
bool isDSTusa();
#line 17 "/Users/chipmc/Documents/Maker/Particle/Projects/AquaMaster-Fountain/src/AquaMasterFSM.ino"
STARTUP(System.enableFeature(FEATURE_RESET_INFO));                      // Track why we reset
SYSTEM_THREAD(ENABLED);
#define DSTRULES isDSTusa
const char releaseNumber[8] = "0.33";                                   // Displays the release on the menu 
...
int setPumpState (String command) // Function to force sending data in current hour
{
  if (command == "1")
  {
    current.pumpPower = true;
...
int setLightState (String command) // Function to force sending data in current hour
{
  if (command == "1")
  {
    current.pumpPower = true;
